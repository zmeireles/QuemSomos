  ...
  return (
    ...
    >
      ...
      <div className="relative w-full sm:w-1/2 mb-0 sm:mb-16 mx-0 sm:ml-16">
        ...
        >
          <h1
            className={`text-4xl sm:text-5xl font-bold tracking-tight mb-4 text-shadow ${
          ...
          <h2
            className={`text-2xl sm:text-3xl font-semibold mb-6 text-shadow ${
              shouldAnimate ? 'animate-slideInLeft' : ''
            }`}
            style={{
              animationDuration: `${slideInLeftDuration}ms`,
          ...
          {texto && (
            <div
              className={`prose prose-lg sm:prose-xl prose-invert max-w-none ${
                shouldAnimate ? 'animate-slideInRight' : ''
              }`}
              style={{
                animationDuration: `${slideInRightDuration}ms`,
                animationDelay: `${animationDelay + 400}ms`,
              }}
            >
              <p className="text-base sm:text-lg leading-relaxed text-shadow">
                {texto}
              </p>
            </div>
          )}
          <div className="mt-8">
            <ProgressDotsExt
              ...
              inactiveDotAnimationSpeed={5000}
            />
          </div>
        </div>
      </div>
